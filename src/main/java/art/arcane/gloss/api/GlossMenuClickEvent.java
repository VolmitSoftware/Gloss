...
public final class GlossMenuClickEvent extends Event implements Cancellable {
  ...
  public GlossMenuClickEvent(Player player, String menuId, String componentId, String ownerPluginName,
