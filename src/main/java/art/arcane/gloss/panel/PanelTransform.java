...
public record PanelTransform(String worldKey, UUID worldUuid, double x, double y, double z,
  ...
  public static PanelTransform at(String worldKey, UUID worldUuid, double x, double y, double z, double yaw) {
    return new PanelTransform(worldKey, worldUuid, x, y, z, yaw, 0.0D, 0.0D, 1.0D);
  }
