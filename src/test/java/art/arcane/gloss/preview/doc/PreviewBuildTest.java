...
public class PreviewBuildTest {
   ...
   * the channel {@code /gloss preview dump} reads from. A live cell colour closure only reports
   ...
   * moments later — a second {@code /gloss preview dump} — must still report its own error.
   */
  @Test
