...
public class MenuEditorActionTest {
  ...
  public void editIsAnInvocableLeafWithExistingMenuCompletion() {
    ...
    DirectorRuntimeParameter menu = edit.getParameters().stream()
        ...
        .findFirst()
        .orElseThrow();
    assertTrue(menu.getCustomHandlerOrNull() instanceof CommandGlossMenu.ExistingMenuHandler);
    assertFalse(menu.getCustomHandlerOrNull().getPossibilities().contains("*"));
    assertTrue(new CommandGlossMenu.MenuNameHandler().getPossibilities().contains("*"));
  }
  ...
  public void playerLinkUsesThePayloadOnlyAsTheClickTarget() {
    ...
    String line = CommandGlossMenu.editorEntryLine(
